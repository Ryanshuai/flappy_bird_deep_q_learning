...
class DQN_Agent:
    def __init__(self, action_size, train=True):
        ...
        if train:
            ...
            self.random_action_probability_decay = 0.9_999
        else:
    ...
    def determine_observe(self, sum_reward):
        ...
        self.writer.add_scalar("Reward/sum_reward", sum_reward, self.learn_counter)
